...
function Hero() {
  return (
    <section className="hero-section relative w-full lg:h-[78vh] h-[68vh] lg:pt-4 ">
        ...
        <div className="w-full h-full relative rounded-[30px] overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-4">
            ...
            <Link
              ...
              className="mt-6 inline-block px-4 py-2 rounded-[10px] text-[16px] bg-white text-black font-semibold hover:bg-gray-200 transition-all duration-300"
            >
              Make a call
            </Link>
          </div>
